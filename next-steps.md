...
The following environment variables are set for `backend` in [resources.bicep](./infra/resources.bicep).
...
- Azure Postgres Flexible Server to host the 'aipowerdapp' database.
